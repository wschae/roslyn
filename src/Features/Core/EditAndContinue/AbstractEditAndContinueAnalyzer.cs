...
namespace Microsoft.CodeAnalysis.EditAndContinue
{
    internal abstract class AbstractEditAndContinueAnalyzer : IEditAndContinueAnalyzer
    {
        ...
        internal abstract void ReportOtherRudeEditsAroundActiveStatement(List<RudeEditDiagnostic> diagnostics, Match<SyntaxNode> match, SyntaxNode oldBody, SyntaxNode newBody, SyntaxNode oldStatement, SyntaxNode newStatement, bool isLeaf, bool isInLambdaBody);
            ...
            [Out]List<RudeEditDiagnostic> diagnostics)
        {
            ...
            for (int i = 0; i < activeNodes.Length; i++)
            {
                ...
                if (hasMatching)
                {
                    ...
                    ReportOtherRudeEditsAroundActiveStatement(diagnostics, match, oldBody, newBody, oldStatementSyntax, newStatementSyntax, isLeaf, oldEnclosingLambdaBody != null);
                }
                else if (match == null)
                {
